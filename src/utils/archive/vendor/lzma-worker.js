...
var LZMA = (function () {
    ...
    function $ByteArrayOutputStream(this$static) {
        this$static.buf = new Uint8Array(1048576);
        this$static.count = 0;
        return this$static;
    }

    function $growBuf(this$static, need) {
        var nb = new Uint8Array(Math.max(this$static.buf.length * 2, need, 1048576));
        nb.set(this$static.buf);
        this$static.buf = nb;
    }
    
    function $toByteArray(this$static) {
        return this$static.buf.subarray(0, this$static.count);
    }
    
    /** cs */
    function $write(this$static, b) {
        if (this$static.count >= this$static.buf.length) $growBuf(this$static, this$static.count + 1);
        this$static.buf[this$static.count++] = b;
    }
    /** ce */
    
    function $write_0(this$static, buf, off, len) {
        if (this$static.count + len > this$static.buf.length) $growBuf(this$static, this$static.count + len);
        this$static.buf.set(buf.subarray(off, off + len), this$static.count);
    ...
    function arraycopy(src, srcOfs, dest, destOfs, len) {
        if (destOfs > 1000000000 || len > 1000000000 || !(destOfs >= 0)) { console.error("SUS destOfs", destOfs, "len", len, "srcOfs", srcOfs, "destlen", dest.length, "destCtor", dest.constructor && dest.constructor.name); }
        try {
        for (var i = 0; i < len; ++i) {
            dest[destOfs + i] = src[srcOfs + i];
        }
        } catch (e) {
            console.error("ARRAYCOPY FAIL destOfs", destOfs, "i", i, "len", len, "srcOfs", srcOfs, "destlen", dest.length, "destCtor", dest.constructor && dest.constructor.name, "err", e.message);
            throw e;
        }
    }
    ...
    function decompress(byte_arr, on_finish, on_progress) {
        ...
        if (sync) {
            this$static.d = lastDecompressor = $LZMAByteArrayDecompressor({}, byte_arr);
...
export { LZMA, _LZMA_WORKER as LZMA_WORKER };
